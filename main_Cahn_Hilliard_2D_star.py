...
r = np.sqrt(Xc**2 + Yc**2)
R0 = 0.2 * Lx          # base radius
A = 0.08 * Lx         # amplitude of "leaves"
k = 6                 # number of leaves (try 5–10)
R_theta = R0 + A * np.cos(k * theta)
p[r <= R_theta] = 1
...
anim.save("media/videos/Cahn_Hilliard_2D_star.mp4", writer=writer)
print("Animation saved as media/videos/Cahn_Hilliard_2D_star.mp4")