...
# Initial condition
t = 0.0
p = np.random.uniform(-1, 1, (Nx, Ny))

# Animation setup
fig, ax = plt.subplots(dpi=200)
# im = ax.imshow(p, cmap=plot_config.cmap_AC, origin='lower', extent=[0, Lx, 0, Ly], vmin=-1, vmax=1, interpolation=interpolation)
im = ax.imshow(p, cmap="rainbow", origin='lower', extent=[0, Lx, 0, Ly], vmin=-1, vmax=1, interpolation=interpolation)
...
anim.save("media/videos/Allen_Cahn_2D_random.mp4", writer=writer)
print("Animation saved as media/videos/Allen_Cahn_2D_random.mp4")
