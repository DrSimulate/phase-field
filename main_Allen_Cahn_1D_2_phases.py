...
dt = 0.2 * dx**2 / M
steps = 500  # total number of time steps to simulate
...
anim.save("media/videos/Allen_Cahn_1D_2_phases.mp4", writer=writer)
print("Animation saved as media/videos/Allen_Cahn_1D_2_phases.mp4")
